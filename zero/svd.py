...
class MangakiSVD(RecommendationAlgorithm):
    ...
    def make_matrix(self, X, y):
        ...
        self.chrono.save('salut')
        print(ratings.mean(axis=0), ratings.mean(axis=1))
        # self.chrono.save(ratings.mean(axis=0), ratings.mean(axis=1))
    ...
    def get_shortname(self):
        ...
        """
        return 'svd3-%d' % self.nb_components
